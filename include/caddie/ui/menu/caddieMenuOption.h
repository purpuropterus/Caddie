...
public:
    ...
    nw4r::ut::Color GetStrokeColor() const {
        return mNameText.GetStrokeColor();
    }
...
public:
    ...
    virtual void DeleteChanges() { SetUnsavedValue(mSavedValue); }
...
public:
    ...
    MenuActionOption(const char* name, Action act, void* arg)
        : IMenuOption(name), mAction(act), mActionArg(arg) {
