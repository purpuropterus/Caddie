...
const char* ENUM_PIN_TYPE[PIN_MAX] = {
    "Pin 1 (B)", "Pin 2 (B)",  "Pin 3 (B)",    "Pin 4 (A)",  "Pin 5 (A)",
    "Pin 6 (A)", "From Score", "Random (All)", "Random (A)", "Random (B)"};
...
const char* ENUM_PIN_TYPE_SPECIAL[SP_PIN_MAX] = {
    "Pin 1", "Pin 2", "Pin 3", "Pin 4", "Pin 5", "Pin 6", "Random (All)"};

//! @brief String binding of wind direction enum
const char* ENUM_WIND_DIR[DIR_MAX] = {"South",     "Southeast", "East",
                                      "Northeast", "North",     "Northwest",
                                      "West",      "Southwest", "Random"};

//! @brief String binding of wind speed enum
const char* ENUM_WIND_SPD[] = {"0",
